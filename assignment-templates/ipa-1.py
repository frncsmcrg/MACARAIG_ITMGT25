...
def savings(gross_pay, tax_rate, expenses):
    ...
    aftertax_pay = (gross_pay - (gross_pay * tax_rate)) // 1
    takehome_pay = aftertax_pay - expenses
    return takehome_pay
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    waste_jobset = total_material - material_consumed
    return str(waste_jobset)+material_units
...
def interest(principal, rate, periods):
    ...
    total_amount = (principal + interest_earned) // 1
    return total_amount
